          ...
          >
            ...
            <div className="max-w-[26rem] rounded-[1rem] border border-[#dce7ee] bg-white p-4 shadow-[0_12px_28px_rgba(15,23,42,0.05)] lg:-ml-14 xl:-ml-20">
              ...
              <div className="mt-4 rounded-[0.9rem] border border-[#e2ebf1] bg-[linear-gradient(180deg,#f8fbfd_0%,#f4f8fb_100%)] px-3 py-3">
                <button
                  aria-label={t('about.journey.certificateAlt')}
                  className="mx-auto block max-w-[15rem] rotate-[-4deg] overflow-hidden rounded-[0.75rem] border border-[#d9e5ec] bg-white shadow-[0_14px_28px_rgba(15,23,42,0.12)] transition-transform duration-300 hover:rotate-0 focus:outline-none focus:ring-2 focus:ring-[#9fc7df]"
