...
type MosaicGallerySectionProps = {
  eyebrow: string
  title: string
  description?: string
  filters: MosaicGalleryFilter[]
  items: MosaicGalleryItem[]
  closeLabel: string
...
function getSpanClass(span: MosaicGalleryItem['span']) {
  if (span === 'large') {
      ...
      <section className="bg-white py-18 sm:py-22" id={sectionId}>
        <div className="mx-auto max-w-7xl px-6">
          <Reveal className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="flex flex-wrap gap-3 lg:max-w-[31rem] lg:justify-end">
              {filters.map((filter) => (
                <button
